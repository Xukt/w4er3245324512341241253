(function() {
    ...
    function headerFeatures() {
            ...
            if (padding > newPadding) {
                if (currY < (headerHeight - newHeaderHeight)) {
                    ...
                    if (!jQuery(selector).hasClass("hero-fullscreen")) {
                        jQuery("#header").removeClass("sticky-transformed direct");
                    }
                    ...
                    if (!jQuery(selector).hasClass("hero-fullscreen")) {
                        jQuery("#header").addClass("sticky-transformed direct");
                    }
                }
            }
        }
        ...
        if (!jQuery("#hero").hasClass("hero-fullscreen")) {
            triggerPoint = jQuery("#hero").height() + headerHeight - 80;
        }
        ...
        if (currY + headerHeight > jQuery(window).height()) {
    ...
    function resizeAdapt() {
                ...
                jQuery(thisEl).children(".column:not(.tallest)").each(function() {
                    if (jQuery(this).find(".col-content").length > 0 && !jQuery(this).find(".col-content").is(':empty')) {
                        ...
                        if (contentHeight < elHeight) {
                            ...
                            if (thisEl.hasClass("col-align-bottom")) {
                                alignMargin = elHeight - contentHeight;
                            }
        ...
        if (jQuery(".fullwidth-section.forcefullwidth").length > 0) {
            ...
            jQuery(".fullwidth-section.forcefullwidth").css({
                'left': '-' + pageBody + 'px'
            });
    ...
    jQuery(window).on("load", function() {
        ...
        var headerHeight = 0;
        if (!jQuery("body").hasClass("hero-fullscreen")) {
        ...
        jQuery('#header').on("click", ".menu-toggle", function() {
            ...
            }, 50); // timeout because burger animation glitch in comb with disablescroll
            return false;
        });
        /* SPAB RICE */
        ...
        if (jQuery().isotope) {
            ...
            jQuery('.grid-filter').on("click", "li a", function() {
                ...
                if (!parentul) {
                    ...
                    setTimeout(function() {
                        jQuery('#' + parentul + ' .isotope-item' + selector + ' [class*="do-anim"]').addClass("animated");
                    }, 200);
        ...
        jQuery('body').on('click', '.totop, #scrolldown', function() {
            ...
            if (jQuery(this).attr("id") === "scrolldown") {
                topPos = jQuery("#page-body").offset().top + 2;
            }
            jQuery('html,body').animate({
                scrollTop: topPos
            }, 1000, 'easeInOutQuart');
